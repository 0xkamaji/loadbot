...
The versioned core model and pure, non-executing resolver for reusable parameterized
invocations are documented in [Recipe architecture](docs/recipe-architecture.md).
Existing shortcuts remain authoritative and require no migration.
